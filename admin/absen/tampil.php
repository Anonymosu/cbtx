                        ...
                        <?php
                            ...
                            foreach ($list as $key => $result) {
                                ...
                                foreach ($result['daftar_hadir'] as $key2 => $harihadir) {
                                    $td = ($harihadir) ? '<td style="vertical-align= middle; text-align: center; background: green; color: white;">✅</td>' : '<td style="vertical-align= middle; text-align: center; background: red;">❌</td>';
                                    echo $td;
                                }
